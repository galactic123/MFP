...
if __name__ == "__main__":
    ...
    GT = get_gt(
        data_path='/opt/project/p/share_data_p_fd/sjj_data/eval2/MME_Benchmark_release_version'
    )
    ...
    answers = [json.loads(line) for line in open(os.path.join('/opt/project/n/mm_school/fudan/project/user/sjj/newfuse/newfuse/LLaVA-main/playground/data/eval/MME/answers', f'{experiment}.jsonl'))]
