...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.model_vqa_loader \
        ...
        --image-folder /opt/project/n/mm_school/fudan/project/user/sjj/deepfuse/eval_d/mnt/data1/user/fan_xiaoran/data/eval_data/gqa/data/images \
