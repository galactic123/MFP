...
CKPT="llava-v1.5-7b-newfuse-seedzeros"
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.model_vqa_loader \
        ...
        --image-folder /opt/project/p/share_data_p_fd/sjj_data \
...
python scripts/convert_seed_for_submission.py \
    ...
    --result-upload-file ./playground/data/eval/seed_bench/answers_upload/llava-v1.5-7b-newfuse-seedzeros.jsonl
